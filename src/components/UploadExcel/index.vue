...
export default {
  ...
  methods: {
    ...
    upload(rawFile) {
      ...
      如果用户没有选择任何文件，则该值为空字符串（""）。
      如果用户选择了多个文件，则 value 表示他们选择的文件列表中的第一个文件。
      可以使用 input 的 HTMLInputElement.files 属性标识其他文件。
      */
      // 为了修复两个文件一样的情况下不能触发change事件 重复上传同一文件，强制把原来的值变空
    ...
    */
    readerData(rawFile) {
      ...
      return new Promise((resolve, reject) => {
        ...
        // reader 可以读取文件的内容 .onload该事件在读取操作完成时触发
        reader.onload = e => {
